...
:root {
  ...
  /* --hint ajustado para contraste WCAG AA+ (ratio ≥ 7:1 sobre bg #FEFEFE e sobre cards levemente acinzentados) */
  --hint: #4B5563;
...
.hero h1, .hero h2 { font-family: var(--serif); font-size: 46px; font-weight: 800; line-height: 1.12; max-width: 700px; margin: 0 auto 16px; color: var(--green); }
...
.section-title, h2.section-title { text-align: center; font-family: var(--serif); font-size: 32px; font-weight: 700; color: var(--green); margin-bottom: 8px; margin-top: 0; }
.section-sub { text-align: center; color: var(--sub); font-size: 20px; font-weight: 700; margin: 0 0 44px 0; }
...
.iphone-status-icons { display: flex; gap: 5px; align-items: center; }
.iphone-home-bar {
  display: flex;
...
.wa-phone { background: #E5DDD5; padding: 12px 12px 0; }
.wa-header {
  background: var(--green);
  color: #fff;
  padding: 10px 14px;
...
.wa-header-sub { font-size: 11px; font-weight: 400; opacity: 0.85; }
.wa-msg { background: #fff; border-radius: 0 8px 8px 8px; padding: 8px 12px; margin-bottom: 6px; font-size: 13px; font-weight: 600; line-height: 1.5; box-shadow: 0 1px 1px rgba(0,0,0,0.05); }
...
.wa-msg .time { font-size: 11px; color: #374151; text-align: right; margin-top: 4px; font-weight: 600; }
...
export default function LembrymedLanding() {
  ...
  return (<>
      ...
      <div className="container impact-inner">
        ...
        <p className="impact-sub">
          ...
          <a
            ...
            style={{fontSize:13, color:'rgba(255,255,255,0.88)', textDecoration:'underline', marginTop:8, display:'inline-block'}}
          >
    ...
    <section className="hero"><div className="container">
      ...
      <h2>Nunca mais esqueça seus medicamentos com o Lembrymed</h2>
    ...
    <section className="section">
      <div className="container">
        ...
        <p className="section-sub">Da assinatura aos lembretes em menos de 5 minutos</p>
    ...
    <section className="wa-section"><div className="container">
      <h2 className="wa-section-title">Segurança para o Paciente e para a Família</h2>
        ...
        <div className="iphone-screen">
          ...
          <div className="iphone-status-bar">
            ...
            <div className="iphone-status-icons">
              <svg width="16" height="12" viewBox="0 0 16 12" fill="currentColor"><rect x="0" y="3" width="3" height="9" rx="1"/><rect x="4.5" y="2" width="3" height="10" rx="1"/><rect x="9" y="0" width="3" height="12" rx="1"/><rect x="13.5" y="1" width="2.5" height="11" rx="1" opacity=".3"/></svg>
              <svg width="15" height="12" viewBox="0 0 15 12" fill="currentColor"><path d="M7.5 2.5C9.8 2.5 11.9 3.5 13.3 5.1L14.7 3.7C12.9 1.8 10.3.5 7.5.5S2.1 1.8.3 3.7L1.7 5.1C3.1 3.5 5.2 2.5 7.5 2.5Z"/><path d="M7.5 5.5C9 5.5 10.3 6.1 11.3 7.1L12.7 5.7C11.3 4.3 9.5 3.5 7.5 3.5S3.7 4.3 2.3 5.7L3.7 7.1C4.7 6.1 6 5.5 7.5 5.5Z"/><circle cx="7.5" cy="10" r="1.5"/></svg>
              <svg width="25" height="12" viewBox="0 0 25 12" fill="none"><rect x=".5" y=".5" width="21" height="11" rx="3.5" stroke="currentColor" strokeOpacity=".35"/><rect x="2" y="2" width="16" height="8" rx="2" fill="currentColor"/><path d="M23 4v4a2 2 0 0 0 0-4Z" fill="currentColor" fillOpacity=".4"/></svg>
            </div>
          </div>
          <div className="wa-phone">
            <div className="wa-header">
              ...
              <div className="wa-header-info">
                <span>Lembrymed</span>
                <span className="wa-header-sub">online</span>
              </div>
            </div>
    ...
    <section className="pricing"><div className="container">
      <h2 className="section-title">Plano simples, preço justo</h2>
