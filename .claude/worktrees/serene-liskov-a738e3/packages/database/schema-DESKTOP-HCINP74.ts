...
// ═══ ADMIN USERS — credenciais administrativas ═══
// Permite recuperação de senha self-service via WhatsApp sem intervenção manual.
// `recovery_phone` é o número que recebe o código de 6 dígitos.
