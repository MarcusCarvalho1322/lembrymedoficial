...
import { Gauge, ConfirmationCell } from '@/components/admin/charts';
import type { PatientDetailResponse } from '@lembrymed/shared';
...
export default function PatientDetailPage() {
  ...
  const load = () => {
    ...
    api<PatientDetailResponse>(`/admin/patients/${phone}`, { token })
      .then(setData)
